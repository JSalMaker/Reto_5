from codex2.point import Point
from codex2.square import Square
from codex2.rectangle import Rectangle
from codex2.equilateral import Equilateral
from codex2.isosceles import Isosceles
from codex2.scalene import Scalene
from codex2.trirectangle import TriRectangle

def print_shape_info(name, shape):
    print(f"{name}")
